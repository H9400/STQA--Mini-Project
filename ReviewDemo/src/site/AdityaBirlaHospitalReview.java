...
public class AdityaBirlaHospitalReview {

    WebDriver driver;

    // Constructor to set up WebDriver and navigate to the website
    public AdityaBirlaHospitalReview() {
    ...
    public void collectReviews() {
        try {
            // Open the given URL
            driver.get("https://www.mouthshut.com/product-reviews/Aditya-Birla-Memorial-Hospital-Chinchwad-Pune-reviews-925602748-page-2");
            ...
            FileWriter writer = new FileWriter("E:\\eclipse_workspace\\Selenium\\AdityaBirlaReviews.txt", true);
    ...
    public static void main(String[] args) {
        AdityaBirlaHospitalReview reviewCollector = new AdityaBirlaHospitalReview();
        reviewCollector.collectReviews();  // Collect reviews and save to the text file
    }
}
